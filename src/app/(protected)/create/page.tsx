...
const RED_OPTIONS = [
  ...
  { value: "X" as RedSocial, label: "X" },
  { value: "LinkedIn" as RedSocial, label: "LinkedIn" },
...
const RED_COLOR: Record<string, string> = { Instagram: "#dc2743", Facebook: "#1877F2", X: "#000000", LinkedIn: "#0A66C2", TikTok: "#000000", WhatsApp: "#25D366" };
// Tinte ~8% (alpha 0x14) del color oficial para el fondo del estado seleccionado.
const RED_TINT: Record<string, string> = { Instagram: "#dc274314", Facebook: "#1877F214", X: "#00000014", LinkedIn: "#0A66C214", TikTok: "#00000014", WhatsApp: "#25D36614" };
